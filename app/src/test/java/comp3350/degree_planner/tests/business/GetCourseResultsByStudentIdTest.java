...
public class GetCourseResultsByStudentIdTest extends TestCase {
    ...
    public void testValid() {
        System.out.println("\nStarting Get Course Results By Student ID Test: valid student id and non-empty course results");

        courseResults = acr.getCourseResultsByStudentId(1);
        assertEquals("ArrayList sizes weren't equal.", 2, courseResults.size());

//        final DataAccessStub testData = new DataAccessStub() {
...
//        };
        ...
        System.out.println("Finished Get Course Results By Student ID Test: valid student id and non-empty course results");
    }
}
